        ...
        <div class="tableBox">
            ...
            <form class="form-search" action="/xzy/project/index.php/Admin/Adminuser/index" method="post">
                <span class="select-box">账号:
                    <input type="text" class="input-medium user" name="name" placeholder="请输入账号" style="width: 100px;"/ >
                </span>
                <span class="select-box">APPID:
                    <input type="text" class="input-medium name" name="appid" placeholder="请输入APPID" style="width: 100px;"/ >
                </span>
                <span class="select-box">APPsecret:
                    <input type="text" class="input-medium phone" name="appsecret" placeholder="请输入APPsecret" style="width: 100px;"/ >
                </span>
                <span class="select-box">商户号:
                    <input type="text" class="input-medium email" name="shopnum" placeholder="请输入商户号" style="width: 100px;"/ >
                </span>
                <span class="select-box">公司:
                    <input type="text" class="input-medium address" name="company" placeholder="请输入公司" style="width: 100px;"/ >
                </span>             
            ...
            <script>
                ...
                /**************** 搜索关键字保留 -- 开始 ******************/
                    ...
                    $('button[type="reset"]').click(function(){
                        location.href = '<?php echo U("Admin/Vendors/index");?>';
