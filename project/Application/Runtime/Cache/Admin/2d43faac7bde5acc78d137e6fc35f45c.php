...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            <div class="titleBar">用户组/<span>用户组详情</span></div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="" href="<?php echo U('Admin/Rule/delete_user_from_group',array('uid'=>$v['id']));?>">
                                    删除
                                </a>
                            </td>
            ...
            <div>
                <a href="<?php echo U('Admin/Rule/check_user', array('group_id'=>$group_data['group_id']));?>" class="btn btn-success">
                            添加成员
                </a>
            </div>
            <script>
