...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            ...
            <form class="form-search" action="/xzy/project/index.php/Admin/Product/index" method="post">
                ...
                <span class="select-box">product_id:
                    <input type="text" class="input-medium typename" name="product_id" placeholder="请输入微信product_id" style="width: 100px;"/ >
                </span>
                <span class="select-box">设置人:
                    <input type="text" class="input-medium typename" name="name" placeholder="请输入设置人" style="width: 100px;"/ >
                </span>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <!-- <?php echo dump($_SESSION['adminuser']['leavel']);?> -->
                </tr>
                </thead>
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                            ...
                            <td><a href="<?php echo U('Admin/product/edit',array('id'=>$vo['id']));?>">编辑</a></td>
