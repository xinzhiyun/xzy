...
<div class="content">
    ...
    <div class="row-fluid fl" id="main">
        <div class="tableBox">
            ...
            <div class="formBox">
                <form class="form-horizontal " action="/xzy/project/index.php/Admin/Product/add" method="post" id="_formTable">
                    <div class="groupBox control-group">
                        <span>微信product_id<sub style="color:red;margin-left: 5px;">*</sub></span>
                        <input type="text" class="control" name="product_id" placeholder="请输入微信product_id" style="width:210px;">
                    </div>
                    <div class="groupBox control-group">
